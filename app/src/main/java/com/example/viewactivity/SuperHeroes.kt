...
class SuperHeroes {
    companion object{
        ...
        val listVideoAdds = listOf<Video>(
            Video("Anuncio 1","Anuncio 1", R.raw.anuncio1),
            Video("Anuncio 2","Anuncio 2", R.raw.anuncio2),
            Video("Anuncio 3","Anuncio 3", R.raw.anuncio3),
            Video("Anuncio 4","Anuncio 4", R.raw.anuncio4),
            Video("Anuncio 5","Anuncio 5", R.raw.anuncio5),
            Video("Anuncio 6","Anuncio 6", R.raw.anuncio6),
            Video("Anuncio 7","Anuncio 7", R.raw.anuncio7),
            Video("Anuncio 8","Anuncio 8", R.raw.anuncio8)
        )
